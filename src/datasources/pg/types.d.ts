...
declare module "knex/types/tables" {
  interface Tables {
    ...
    books_composite: Knex.CompositeTableType<
      ...
      Pick<BookModel, "title" | "author"> & Partial<Pick<BookModel, "computedProperty">>,
    ...
    authors_composite: Knex.CompositeTableType<AuthorModel, Pick<AuthorModel, "name">, Partial<Omit<AuthorModel, "id">>>
  }
}
